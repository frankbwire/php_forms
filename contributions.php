...
<body>
    ...
    <div class="container">
        ...
        <p>The table below shows all&nbsp;<strong>CONTRIBUTIONS </strong>made to your group.</p>
        <hr>
            ...
            <table class="table table-striped table-sm">
                <thead style="background-color: #80de54;letter-spacing: 1px;font-size: 14px;">
                    <tr class="text-monospace">
                      ...
                      <?php
            $sql="select * from contributions order by contribution_date desc;";
                 ...
                 <tbody>
                    <tr>
                        <td><?php echo $row["contribution_id"];  ?></td>
                         ...
                         <td><?php echo $row["total_shares"];  ?></td>
